...
def test_duplicate_page():
    ...
    async def main():
        ...
        await client.duplicate_page(
            page_id="8c93fa8355344cbd88544b3a076ef552",  # https://www.notion.so/8c93fa8355344cbd88544b3a076ef552
            destination_page_id="5caeefe3bf5645b39b0995f02fc55b82",  # https://www.notion.so/5caeefe3bf5645b39b0995f02fc55b82
        )
