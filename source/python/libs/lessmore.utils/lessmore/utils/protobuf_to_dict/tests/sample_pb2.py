...
_STATUS = _descriptor.EnumDescriptor(
    ...
    file=DESCRIPTOR,
    values=[
        _descriptor.EnumValueDescriptor(name="OK", index=0, number=0, options=None, type=None),
        _descriptor.EnumValueDescriptor(name="ERROR", index=1, number=1, options=None, type=None),
    ],
...
_MESSAGEOFTYPES_ENUM = _descriptor.EnumDescriptor(
    ...
    file=DESCRIPTOR,
    values=[
        _descriptor.EnumValueDescriptor(name="A", index=0, number=0, options=None, type=None),
        _descriptor.EnumValueDescriptor(name="B", index=1, number=1, options=None, type=None),
        _descriptor.EnumValueDescriptor(name="C", index=2, number=2, options=None, type=None),
    ],
    containing_type=None,
    options=None,
...
_MESSAGEOFTYPES_SIMPLEMAPENTRY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="key",
            full_name="tests.MessageOfTypes.SimpleMapEntry.key",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="value",
            full_name="tests.MessageOfTypes.SimpleMapEntry.value",
            index=1,
            number=2,
            type=2,
            cpp_type=6,
...
_MESSAGEOFTYPES_NESTEDMAPENTRY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="key",
            full_name="tests.MessageOfTypes.NestedMapEntry.key",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="value",
            full_name="tests.MessageOfTypes.NestedMapEntry.value",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_MESSAGEOFTYPES_INTMAPENTRY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="key",
            full_name="tests.MessageOfTypes.IntMapEntry.key",
            index=0,
            number=1,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="value",
            full_name="tests.MessageOfTypes.IntMapEntry.value",
            index=1,
            number=2,
            type=5,
            cpp_type=1,
...
_MESSAGEOFTYPES_NESTEDTYPE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="req",
            full_name="tests.MessageOfTypes.NestedType.req",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_MESSAGEOFTYPES = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="dubl",
            full_name="tests.MessageOfTypes.dubl",
            index=0,
            number=1,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="flot",
            full_name="tests.MessageOfTypes.flot",
            index=1,
            number=2,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="i32",
            full_name="tests.MessageOfTypes.i32",
            index=2,
            number=3,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="i64",
            full_name="tests.MessageOfTypes.i64",
            index=3,
            number=4,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name="ui32",
            full_name="tests.MessageOfTypes.ui32",
            index=4,
            number=5,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name="ui64",
            full_name="tests.MessageOfTypes.ui64",
            index=5,
            number=6,
            type=4,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            name="si32",
            full_name="tests.MessageOfTypes.si32",
            index=6,
            number=7,
            type=17,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="si64",
            full_name="tests.MessageOfTypes.si64",
            index=7,
            number=8,
            type=18,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name="f32",
            full_name="tests.MessageOfTypes.f32",
            index=8,
            number=9,
            type=7,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name="f64",
            full_name="tests.MessageOfTypes.f64",
            index=9,
            number=10,
            type=6,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            name="sf32",
            full_name="tests.MessageOfTypes.sf32",
            index=10,
            number=11,
            type=15,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="sf64",
            full_name="tests.MessageOfTypes.sf64",
            index=11,
            number=12,
            type=16,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name="bol",
            full_name="tests.MessageOfTypes.bol",
            index=12,
            number=13,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name="strng",
            full_name="tests.MessageOfTypes.strng",
            index=13,
            number=14,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="byts",
            full_name="tests.MessageOfTypes.byts",
            index=14,
            number=15,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="nested",
            full_name="tests.MessageOfTypes.nested",
            index=15,
            number=16,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="enm",
            full_name="tests.MessageOfTypes.enm",
            index=16,
            number=17,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="nestedRepeated",
            full_name="tests.MessageOfTypes.nestedRepeated",
            index=17,
            number=18,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="enmRepeated",
            full_name="tests.MessageOfTypes.enmRepeated",
            index=18,
            number=19,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="simpleMap",
            full_name="tests.MessageOfTypes.simpleMap",
            index=19,
            number=20,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="nestedMap",
            full_name="tests.MessageOfTypes.nestedMap",
            index=20,
            number=21,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="intMap",
            full_name="tests.MessageOfTypes.intMap",
            index=21,
            number=22,
            type=11,
            cpp_type=10,
    ...
    extensions=[],
    nested_types=[
        _MESSAGEOFTYPES_SIMPLEMAPENTRY,
        _MESSAGEOFTYPES_NESTEDMAPENTRY,
        _MESSAGEOFTYPES_INTMAPENTRY,
        _MESSAGEOFTYPES_NESTEDTYPE,
    ],
    enum_types=[
...
_OBJ = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="transacted_at",
            full_name="tests.Obj.transacted_at",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
...
MessageOfTypes = _reflection.GeneratedProtocolMessageType(
    "MessageOfTypes",
    (_message.Message,),
    dict(
        SimpleMapEntry=_reflection.GeneratedProtocolMessageType(
            "SimpleMapEntry",
            (_message.Message,),
            dict(
        ...
        NestedMapEntry=_reflection.GeneratedProtocolMessageType(
            "NestedMapEntry",
            (_message.Message,),
            dict(
        ...
        IntMapEntry=_reflection.GeneratedProtocolMessageType(
            "IntMapEntry",
            (_message.Message,),
            dict(
        ...
        NestedType=_reflection.GeneratedProtocolMessageType(
            "NestedType",
            (_message.Message,),
            dict(
...
Obj = _reflection.GeneratedProtocolMessageType(
    "Obj",
    (_message.Message,),
    dict(
        DESCRIPTOR=_OBJ,
...
Objs = _reflection.GeneratedProtocolMessageType(
    "Objs",
    (_message.Message,),
    dict(
        DESCRIPTOR=_OBJS,
