    ...
    async def main():
        await asyncio.gather(
            *[
                ...
                run(prompt="The elder scrolls, thick black outlines, soft rays of light, dust particles, 4k, photorealistic, simulation, ultrasharp, Close up view. A cat with a beard"),
                run(prompt="The elder scrolls, thick black outlines, soft rays of light, dust particles, 4k, photorealistic, simulation, ultrasharp, Close up view. A man running a marathon"),
                run(prompt="The elder scrolls, thick black outlines, soft rays of light, dust particles, 4k, photorealistic, simulation, ultrasharp, Close up view. A factory in hell"),
                run(prompt="The elder scrolls, thick black outlines, soft rays of light, dust particles, 4k, photorealistic, simulation, ultrasharp, Close up view. A god wrath with a sword towards the heavens"),
            ]
        )
