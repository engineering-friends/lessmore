...
Буду пересылать комментарии к постам, в которых ты участвуешь.

Чтобы отписаться, поставь *любую* реакцию на пересланное мной сообщение.

Оставь комментарий, чтобы посмотреть как это работает: https://t.me/c/2219948749/187?thread=185""")
            )
