...
class EfOrgBot:
    ...
    def menu(self) -> Block:
        return Block(
            "⚙️ *Выбери действие*",
            inline_keyboard=[
                [("Подготовить онбординг", self.start_onboarding)],
    ...
    - В канал [EF Channel](https://t.me/+I344iBZx30MyMGUy). Там у нас все посты и запросы - в том числе твои будут
    - В чатик [EF Random Coffee](https://t.me/+MH67ENSn0T5jMzIy) - там основные знакомства, участвуй! :)
    ...
    """)
        ...
        await response.ask(
            ...
            inline_keyboard=[["🏀 Дальше мячик на моей стороне!"]],
        )
