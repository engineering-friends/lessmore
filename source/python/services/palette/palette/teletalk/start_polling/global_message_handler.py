    ...
    async def global_message_handler(message: Message) -> None:
        ...
        if message.text.startswith("/"):
            ...
            if command in command_starters:
                user_context.start_new_talk(starter_message=message, callback=command_starters[command])
                return
        ...
        user_context.start_new_talk(starter_message=message, callback=message_starter)
